    ...
    useEffect(() => {
        ...
        const fetchSpotifyData = async () => {
            try {
                ...
                // If no access token, try PKCE exchange
                ...
                // If no access token and no PKCE code, redirect to home/login
                if (!accessToken && !code) {
                    router.push('/'); // replace '/' with your login/home page if different
                }
            } catch (err) {
